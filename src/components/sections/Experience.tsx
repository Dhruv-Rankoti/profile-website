                    ...
                    <div className="flex items-start justify-between gap-3 mb-1">
                      <div className="flex items-center gap-3">
                        <div className="shrink-0 size-9 rounded-lg border overflow-hidden" style={{ borderColor: "var(--border)", backgroundColor: "var(--bg)" }}>
                          <Image src={exp.logo} alt={exp.company} width={36} height={36} className="object-contain w-full h-full" />
                        </div>
                        <div>
                          <h3 className="font-bold text-sm" style={{ color: "var(--text)" }}>{exp.role}</h3>
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        <motion.div animate={{ rotate: expanded === exp.id ? 180 : 0 }} transition={{ duration: 0.2 }}>
